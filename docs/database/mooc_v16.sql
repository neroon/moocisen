...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 07 Mars 2016 à 10:47
...
(1, 'CV Ingénieur ISEN', 'FHES', 'Ce MOOC vous permettra de connaitre les codes pour la réalisation d''un CV pour un ingénieur, et plus particulièrement dans le monde du numérique pour une recherche de stage ou d''emploi.', 'Aucun', 35, 4, 7),
