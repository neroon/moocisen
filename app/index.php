                               ...
                               if ((isset($_SESSION['login'])) && (!empty($_SESSION['login'])))
                                {
                                    ...
                                    ("
                                    <li>
                                        <a href='vues/profil.php'> <span class='glyphicon glyphicon-user' aria-hidden='true'></span> ".$_SESSION['pseudo']."</a>
                                    </li>
                                    <li>
                                ...
                                else
                                {
                                    ...
                                    ("
                                    <li>
                                        <a href='vues/inscription1.php'> <span class='glyphicon glyphicon-log-in' aria-hidden='true'></span> Connexion</a>
                                    </li>
                                    ");
                                }
                                        ...
                                        <div class="front">
                                            ...
                                            <div class="content">
                                                <div class="main">
                                                    ...
                                                    <a href="vues/description.php?idM='.$lignes[$i]["id_mooc"].'"<button name="id" class="btn btn-block btn-md btn-info">Description du cours</button> </a>
