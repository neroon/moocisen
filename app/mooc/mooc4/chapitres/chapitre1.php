				...
				<div class="x_content">
					<div class="my_step_box">
						...
						<div class="box1" id="1">
							...
							<p dir="ltr">
									Dans une nuit fraîche de printemps où la rosé du matin est en pleine apparition, une lumière claire obscur approche… 
Cette faible lumière dévoila un homme. Il était vieux, grand avec une longue barbe grise et dans ses mains il tenait un bouquin. Quatre autres personnes de plus petites tailles et indescriptible se tiennent derrière lui.
Le vieil homme qu’on pourrait apparenter à un magicien se penche vers toi et dit:
							</p>
							<p dir="ltr">
								“Qui es-tu mon vieil ami? ”
							</p>
							<p dir="ltr">
								“Ahh ****... j’ai entendu parler de toi! Tu es l’élu… nous avons besoin de ton savoir et de tes compétences pour entreprendre une noble quête…”
							</p>
							<p dir="ltr">
								“Quelle quête?”
							</p>
							<p dir="ltr">
								“Tu dois prendre ce livre et diriger nos troupes à la victoire…”
							</p>
							<p dir="ltr">
								“Mais qu’est-ce que ce bouquin???”
							</p>
							<p dir="ltr">
								“Mon cher enfant… ce bouquin est le PMBOK! Grâce à lui tu seras le plus grand manager que le monde aura connu! 
							</p>
							<p dir="ltr">
								Veux-tu participer à cette aventure?
							</p>
