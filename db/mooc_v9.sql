...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 23 Mai 2016 à 15:11
...
(2, 2, 'Formation', 'Introduction-Titre-Dates', 1),
...
(1, 'Parmi les propositions suivantes, choisir la bonne réponse. Le nom et prenom il faut l’écrire sous la forme suivante (plusieurs réponses sont possibles):', 'M. Clément GUIOL-Olivier Garnier-Madame Olivia Serre-Mme Odette Dupont-Olivier SCHULTZ-Victor Gerard-Slavyana Kokorina-Monsieur Jeson Dupont-Jean Nicolas-PERRICHON Guillaume-Clément DAVID', 'Olivier SCHULTZ-Clément DAVID', 'devine1', 'df', 1),
...
(22, 'Vous voulez mettre un lien vers votre réseau social. Le lien vers quel réseau social allez vous choisir? Choisissez la (les) bonne(s) réponse(s)', 'Facebook avec le contenu de votre vie privé-	Badoo-Viadéo-MySpace-Linkedin-	Twitter professionnel-Google+-	Pinterest-Facebook professionnel', 'Viadéo-Linkedin-Twitter professionnel-Facebook professionnel', 'devine', '', 25),
(23, 'Choisissez parmi les propositions suivantes les qualificatifs qu’il faut surtout pas utiliser dans son CV: (Cette partie comporte 4 parties avec 5 propositions chacune)<br><br>\r\nPartie 1:<br>\r\n', 'Actif-Managé-Motivé-Expert -Autonome', 'Motivé-Expert ', 'devine', '', 26),
(24, 'Partie 2:', 'Résolu-Remporté-Leadership-Efficace-Organisé', 'Leadership-Organisé', 'devine', '', 26),
(25, 'Partie 3:', 'Passionné-Rigoureux-Créatif-Curieux-Specialisé', 'Passionné-Créatif-Specialisé', 'devine', '', 26),
(26, 'Partie 4:', 'Realisé -Innovant-Strategique-Réactif-Dynamique', 'Innovant-Strategique-Dynamique', 'devine', 'c', 26),
