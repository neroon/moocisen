	...
	//$email_body = "Voici votre le lien pour le nouveau mot de passe\n\n"."\n\nEmail: <a href='mooc/reset_password?id=$email_address'>$email_address</a>\n\nUrl: $urlLink\n\n$message";
     ...
     <html>
      ...
      <body>
       ...
       URL: <a href='.$url.'/application/modules/reset_password.php?id='.$urlLink.'>'.$url.'/application/modules/reset_password.php?'.$urlLink.'</a> <br>
       '.$message.' <br>
...
if($verifMail==0){
	...
	echo '<br>Url a envoyer = '.$url.'/moocisen/application/modules/reset_password.php?id='.$urlResetPwd;
